...
<body class="bg-white">
    ...
    <!-- Full-width Banner -->
    <div class="w-full">
        <img src="{{ asset('img/home-banner-2.jpg') }}" alt="Dashboard Banner" class="w-full h-auto object-cover">
    </div>
    ...
    <section class="w-full py-8" style="background-color: #fff5f5;">
        <div class="max-w-[1440px] mx-auto px-4">
            <h2 class="text-center text-2xl mb-6" style="font-family: 'Lora', serif;">NEW ARRIVALS</h2>
            ...
            <div class="flex overflow-x-auto space-x-6 scrollbar-hide">
                @forelse ($products as $product)
                    <div class="flex-shrink-0 w-64 bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition duration-300 cursor-pointer"
                        onclick="openPreview('{{ $product->name }}','{{ $product->price }}','{{ $product->description }}','{{ $product->image ?? 'https://via.placeholder.com/300x200?text=No+Image' }}')">
                        
                        <img src="{{ $product->image ?? 'https://via.placeholder.com/300x200?text=No+Image' }}" alt="{{ $product->name }}" class="w-full h-48 object-cover rounded-t-lg">
    ...
    <section class="w-full bg-[#ffbdbd] flex items-center justify-center px-4 py-8 sm:px-6">
        <div class="text-center max-w-3xl">
            <p class="text-lg sm:text-xl font-semibold text-black leading-relaxed" style="font-family: 'Lora', serif;">
                "INVEST IN YOUR SKIN, IT IS GOING TO<br />REPRESENT YOU FOR A VERY LONG TIME"
            </p>
            <p class="text-right text-sm text-gray-600 mt-2" style="font-family: 'Lora', serif;">— Linden Tyler</p>
        </div>
    </section>

    <!-- Second Banner -->
    <section class="w-full flex justify-center">
        <img src="{{ asset('img/ANUA_home.png') }}" alt="Dashboard Banner 2" class="w-full max-w-[1440px] h-auto object-cover"/>
    </section>

    <!-- Customer Reviews Section -->
    <section class="bg-pink-50 py-12 ">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 class="text-center text-2xl mb-6" style="font-family: 'Lora', serif;">WHAT OUR CUSTOMER SAY</h2>
