{{-- resources/views/categories/cleanser.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cleanser Products</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <section class="max-w-7xl mx-auto px-6 py-12 flex-1">
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                ...
                @empty
                    <p class="col-span-4 text-center text-gray-600">No cleansers found in this category.</p>
                @endforelse
            </div>
        </section>
